...
\subsection{Символіка Ландау (О-велике, о-маленьке) та відношення еквівалентності}
\begin{definition}
Задані функції $f,g \colon A \to \mathbb{R}$ та $x_0 \in \mathbb{R}$ -- гранична точка для $A$.\\
