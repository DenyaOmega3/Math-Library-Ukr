...
\end{definition}
	...
	\end{align*}
	\begin{align*}
	\forall \{x_n, n \geq 1\}\subset A: \forall n \geq 1: x_n \neq x_0: \lim_{n \to \infty} x_n = x_0 \Rightarrow \lim_{n \to \infty} f(x_n) = b \tag*{означення Гейне}
	\end{align*}
	...
	\textit{Випливає з означення Гейне, оскільки границя числової послідовності -- єдина.}
	\end{remark}
...
\fi %uncomment picture
	...
	\begin{remark}
	Аналогічними міркуваннями можна самостійно записати означення Коші та означення Гейне для випадку, коли в нас $\displaystyle \lim_{x \to \infty} f(x) = \infty$.
	\end{remark}
	
	\begin{remark}
	Для інших варіацій границь функції: $\displaystyle\lim_{x \to x_0} f(x) = \infty, \lim_{x \to \infty} f(x) = b, \lim_{x \to \infty} f(x) = \infty$ -- еквівалентність двох означень, за Коші та за Гейне, також залишається в силі.
	\end{remark}
...
\item \textbf{строго зростаючою}, якщо $\forall x_1,x_2 \in (a,b): x_1 > x_2 \Rightarrow f(x_1)>f(x_2)$;
\item \textbf{не спадною}, якщо $\forall x_1,x_2 \in (a,b): x_1 > x_2 \Rightarrow f(x_1) \geq f(x_2)$;
\item \textbf{строго спадною}, якщо $\forall x_1,x_2 \in (a,b): x_1 > x_2 \Rightarrow f(x_1) < f(x_2)$;
\item \textbf{не зростаючою}, якщо $\forall x_1,x_2 \in (a,b): x_1 > x_2 \Rightarrow f(x_1) \leq f(x_2)$.
\end{itemize}
...
Це означає, що границя не залежить від вибору послідовності. Тому за Гейне, отримаємо, що $\exists \displaystyle \lim_{x \to x_0} f(x) = b$.
\end{proof}
...
Функція $f(x)$ називається \textbf{неперервною в точці} $x_0$, якщо
	...
	\end{align*}
	\begin{align*}
	\forall \{x_n, n \geq 1\}\subset A: \lim_{n \to \infty} x_n = x_0 \Rightarrow \lim_{n \to \infty} f(x_n) = f(x_0) \tag*{означення Гейне}
	\end{align*}
\end{definition}
