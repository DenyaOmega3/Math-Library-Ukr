...
2. Нехай $B_1,B_2 \in \mathcal{B}$. Вони вдвох -- відкриті (див. зауваження). Значить, $B_1 \cap B_2$ є відкритою множиною, а тому $B_1 \cap B_2 = \displaystyle\bigcup_{U \in \mathcal{B}} U$.
\end{proof}
...
\begin{proof}
\rightproof Дано: $\mathcal{S}$ -- передбаза топології. Для зручності позначу початкову топологію за $\tau_{\mathcal{S}}$.\\
Припустимо, що $\tau$ -- слабша топологія, що містить $\mathcal{S}$, тобто $\tau \subset \tau_{\mathcal{S}}$. Нам залишилося довести, що $\tau_{\mathcal{S}} \subset \tau$.\\
...
\noindent
Цей приклад можна трактувати інакше: у нас ''дуже багато'' відкритих множин, які нам заважають жити. Аби працювало твердження вище, ми трошки змінимо базу ось таким чином:
\begin{align*}
